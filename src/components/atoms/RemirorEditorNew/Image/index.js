...
import { blockActive, findSelectedNodeWithType } from 'smartblock';
import { Extension, Dispatch } from 'smartblock'
...
export default class Image extends Extension {
  ...
  // captionClassName;
  // withCaption;
  // onChange: (preview, file) => Promise<string>;
  ...
  get icon() {
    return <img src={'/images/posts/image.svg'} />
  }
  get plugins() {
    return [MediaPlugin()]
  }
  async changeImage(state, dispatch, files) {
