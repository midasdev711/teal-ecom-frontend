...
const image = `https://cdn.shopify.com/s/files/1/0451/1472/0419/products/0_Ryder-Shoes-Men-And-Women-Dropship-Indestructible-Steel-Toe-Air-Safety-Boots-Puncture-Proof-Work-Sneakers_1_300x300_cc63d031-a9b3-4a95-8fb4-e12f8cf7e49d_50x50@3x.jpg?v=1596714418`;
            ...
            <ContentBox marginTop="20px">
              ...
              <ConditionContent>
                <div className="condition-wrap">
                  <StyledSearch
                    enterButton={<Button>Browse products</Button>}
              ...
              <Divider />
              <AlignItem className="product-item">
